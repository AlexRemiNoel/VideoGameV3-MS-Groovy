...
import com.champsoft.profiledashboardmanagement.Presentation.UserController;
...
class UserControllerUnitTest {
    ...
    void addUser_whenValidRequest_thenReturnCreatedUser() {
        // Arrange
        UserResponseModel addedUser = new UserResponseModel(UUID.randomUUID().toString(), "newUser", "new@test.com", 25.0, new ArrayList<>());
    ...
    void updateUser_whenUserExists_thenReturnUpdatedUser() {
        // Arrange
        UserResponseModel updatedUser = new UserResponseModel(userId1, "updatedUser", "updated@test.com", 100.0, new ArrayList<>()); // Balance not updated here
    ...
    void updateUserBalance_whenUserExistsAndBalanceValid_thenReturnUpdatedUser() {
        ...
        UserResponseModel updatedUserResponse = new UserResponseModel(userId1, "user1", "user1@test.com", newBalance, new ArrayList<>());
