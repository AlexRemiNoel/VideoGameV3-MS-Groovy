...
class UserServiceUnitTest {
    ...
    void setUp() {
        ...
        user1 = new User(new UserId(userId1), "user1", "user1@test.com", "pass1", 100.0,  new ArrayList<>());
        user2 = new User(new UserId(userId2), "user2", "user2@test.com", "pass2", 50.0,  new ArrayList<>());
        userRequestModel = new UserRequestModel("newUser", "new@test.com", "newPass", 25.0);
        userResponseModel1 = new UserResponseModel(userId1, "user1", "user1@test.com", 100.0,  new ArrayList<>());
        userResponseModel2 = new UserResponseModel(userId2, "user2", "user2@test.com", 50.0, new ArrayList<>());
    }
    ...
    void addUser_whenValidRequest_thenReturnAddedUser() {
        // Arrange
        User newUser = new User(new UserId(UUID.randomUUID().toString()), "newUser", "new@test.com", "newPass", 25.0, new ArrayList<>());
        UserResponseModel newUserResponse = new UserResponseModel(newUser.getUserId().getUuid(), newUser.getUsername(), newUser.getEmail(), newUser.getBalance(), newUser.getGames());
    ...
    void addUser_whenNegativeBalance_thenThrowInvalidUserInputException() {
        ...
        User invalidUser = new User(new UserId(UUID.randomUUID().toString()), "invalidUser", "invalid@test.com", "pass", -10.0, new ArrayList<>());
    ...
    void updateUser_whenUserExists_thenReturnUpdatedUser() {
        ...
        User updatedUser = new User(new UserId(userId1), "updatedUser", "updated@test.com", "updatedPass", 100.0, new ArrayList<>()); // Balance unchanged by this method
        UserResponseModel updatedResponse = new UserResponseModel(userId1, "updatedUser", "updated@test.com", 100.0, new ArrayList<>());
    ...
    void updateUserBalance_whenUserExistsAndBalanceValid_thenReturnUpdatedUser() {
        ...
        User userWithUpdatedBalance = new User(new UserId(userId1), "user1", "user1@test.com", "pass1", newBalance, new ArrayList<>());
        UserResponseModel updatedResponse = new UserResponseModel(userId1, "user1", "user1@test.com", newBalance, new ArrayList<>());
